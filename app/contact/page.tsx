    ...
    <div>
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 font-serif text-5xl font-semibold leading-[1.05] tracking-tight text-navy-900 sm:text-6xl">
              Talk to us. Book a{" "}
              <span className="text-gold-600 italic">free demo</span>.
            </h1>
      ...
      <section className="border-t border-cream-200 bg-white py-16 sm:py-20">
        <Container>
          <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr]">
            <div className="space-y-4">
              <a
                ...
                className="flex items-start gap-4 rounded border border-cream-200 bg-cream-50 p-6 transition hover:border-gold-400 hover:bg-white"
              >
              ...
              <a
                ...
                className="flex items-start gap-4 rounded border border-cream-200 bg-cream-50 p-6 transition hover:border-gold-400 hover:bg-white"
              >
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded bg-navy-900 text-gold-400">
              ...
              <div className="flex items-start gap-4 rounded border border-cream-200 bg-cream-50 p-6">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded bg-navy-900 text-gold-400">
            ...
            <div id="enquiry" className="scroll-mt-24 rounded border border-cream-200 bg-cream-50 p-7 sm:p-10">
          ...
          <div className="mt-12 overflow-hidden rounded border border-cream-200">
            <iframe
