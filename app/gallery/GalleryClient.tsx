...
const sections: Section[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      { file: "teachers-day/td-01.jpeg", alt: "Students and faculty group selfie on Teachers' Day at ESA Rohini", caption: "Group selfie with the whole Teachers' Day crew" },
      { file: "teachers-day/td-02.jpeg", alt: "Full ESA batch with faculty on Teachers' Day amid balloon decor", caption: "Full batch with sir, ready for the frame" },
      { file: "teachers-day/td-03.jpeg", alt: "Senior batch group photo with mentor on Teachers' Day at ESA Rohini", caption: "Senior batch lined up for the camera" },
      { file: "teachers-day/td-04.jpeg", alt: "ESA juniors posing in front of Happy Teachers' Day banner", caption: "Juniors in front of the Happy Teachers banner" },
      { file: "teachers-day/td-05.jpeg", alt: "Middle-school ESA students posing on Teachers' Day", caption: "Middle-school batch, all smiles" },
      { file: "teachers-day/td-06.jpeg", alt: "ESA batch students posing by decorated wall on Teachers' Day", caption: "Batch posing by the decorated wall" },
      { file: "teachers-day/td-07.jpeg", alt: "Three ESA students posing on Teachers' Day at the Rohini centre", caption: "Three friends, one Teachers' Day frame" },
      { file: "teachers-day/td-08.jpeg", alt: "Two junior ESA students on Teachers' Day at Rohini", caption: "Two juniors, arms around shoulders" },
      { file: "teachers-day/td-09.jpeg", alt: "ESA faculty selfie on Teachers' Day at Rohini", caption: "A quick selfie between mentors" },
      { file: "teachers-day/td-10.jpeg", alt: "ESA founder and faculty during Teachers' Day celebration", caption: "Founder and faculty share a break" },
      { file: "teachers-day/td-11.jpeg", alt: "Large group selfie of ESA students and teachers on Teachers' Day", caption: "Everyone leans in for the group selfie" },
      { file: "teachers-day/td-12.jpeg", alt: "ESA faculty cutting the Teachers' Day cake at Rohini centre", caption: "Cutting the Teachers' Day cake together" },
    ],
  },
  {
    id: "birthdays",
  ...
  },
  {
    id: "centre",
    title: "Our Centres",
    eyebrow: "Three branches across Delhi and Lucknow",
    blurb:
      "Rohini Sector 7, Rohini Sector 15 and Lucknow Thakurganj. Look for the bright yellow ESA board - you're there.",
    icon: <MapPin className="h-5 w-5" />,
    accent: "ink",
    photos: [
