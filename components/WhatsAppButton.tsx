...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-emerald-500/35 transition hover:scale-105"
    >
      <svg
        viewBox="0 0 32 32"
        className="h-7 w-7"
