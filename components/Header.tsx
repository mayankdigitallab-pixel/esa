...
function buildSearchIndex(): SearchHit[] {
  ...
  const pages: SearchHit[] = [
    ...
    { title: "Our Branches - Delhi & Lucknow", type: "Page", href: "/centres", keywords: "centres branches rohini sector 7 sector 15 lucknow thakurganj address map directions" },
    { title: "ESA Rohini Sector 7", type: "Page", href: "/rohini-sector-7", keywords: "rohini sector 7 flagship centre c7/72 second floor north delhi mamta cbse coaching" },
    { title: "ESA Rohini Sector 15", type: "Page", href: "/rohini-sector-15", keywords: "rohini sector 15 north delhi dhruv narayan cbse coaching" },
