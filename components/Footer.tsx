      ...
      <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-16 sm:px-6 lg:grid-cols-5 lg:gap-12 lg:px-8 lg:py-20">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm">
            ...
            <li><Link href="/timetable" className="text-neutral-300 transition hover:text-white">Time Table</Link></li>
            <li><Link href="/blog" className="text-neutral-300 transition hover:text-white">Blog</Link></li>
