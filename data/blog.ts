...
<h2>Ayush Goel, Class 12 PCM, 96.4 percent</h2>
<p>Ayush joined ESA in Class 11. His Class 10 score was a solid 84 percent but he had never crossed 90 before. By the end of Class 12 he was scoring 96.4 in his CBSE boards including 99 in Maths.</p>
<p>His routine looked like this. He attended Math, Physics and Chemistry batches at ESA six days a week. Every Saturday he wrote a chapter test on whatever was just finished. Every month he sat for a full mock paper. By December all of Class 12 syllabus was done and he had already attempted ten previous year papers.</p>
<p>His own words: "Weekly tests at ESA prepared me for the real board pressure. By the time I sat for the actual exam, I had already written the same paper format twenty-five times. It just felt like another Saturday."</p>

<h2>Sneha Khanna, Class 12 Commerce, 95.2 percent</h2>
<p>Sneha came to ESA in Class 11 with anxiety about Accountancy. By Class 12 boards she scored 98 in Accounts. The shift came from one specific thing: doubt sessions every Saturday at 6 PM where she could ask the same question three times until she actually understood it.</p>
<p>"Accountancy used to terrify me. Now it is my favourite subject," she says. "Sir would solve the same type of journal entry on the board, then make me solve it again, then make me explain it to another student. By Term 1 I was the one others were asking."</p>
...
<ul>
<li><strong>They wrote every weekly test, even when they did not feel ready.</strong> Skipping tests is the number one habit that pushes a 90+ student down to 80.</li>
<li><strong>They sat for at least 8 mock papers before the boards.</strong> By the time boards arrive, the format and time pressure feel normal.</li>
<li><strong>They asked stupid questions out loud.</strong> The students who stay silent in class because they are afraid of looking dumb are usually the ones who fall behind.</li>
</ul>

<h2>The unglamorous truth</h2>
<p>None of these students are geniuses. None of them did 14-hour study days. None of them studied 90 chapters a month. What they all did is show up to weekly tests, sit for monthly mocks, and stay till doubt session finished even when it ran past 9 PM.</p>
<p>That is the entire system at ESA Rohini. If your child is willing to do that for one year, the marks follow on their own.</p>
...
<h2>1. Ask to sit in a real class, not a special demo</h2>
<p>Every institute will gladly invite you for a demo. The question is, is the demo their actual teaching, or is it a curated 45-minute show?</p>
<p>Ask: "Can my child attend the actual batch for one full week?" If the answer is yes, you have a real institute. If the answer is "Saturday is our demo day," that is a tell. The Saturday demo is the institute's best foot forward. Tuesday at 6 PM is the truth.</p>
<p>At ESA Rohini we offer 7 days of free demo classes. Real batches. Your child sits with the kids they would actually study with.</p>

<h2>2. Find out the batch size before you ask about fees</h2>
<p>This is the single most predictive variable for whether your child will benefit. A batch of 50 is not coaching, it is a lecture. A batch of 15 to 20 is the sweet spot for board prep. A batch of 8 to 12 is what specialist subjects like Class 12 PCM need.</p>
<p>Be suspicious of institutes that dodge this question. Be very suspicious of any institute that talks about how many "AI-powered features" they have but cannot tell you how many kids sit in one classroom.</p>

<h2>3. Look at the weekly test schedule</h2>
<p>Ask to see the test calendar for the next two months. Good institutes will show it to you. They will tell you exactly which chapter is being tested when, and what happens if your child scores below 60 percent.</p>
<p>If the answer is "we do regular tests," ask "how regular and how do you grade them?" If the answer is vague, the tests are vague too.</p>

<h2>4. Check who actually teaches</h2>
<p>Many chain institutes advertise senior faculty in the brochure but actually have junior assistants running daily batches. Ask for the name of the teacher who will handle your child's class. Then ask to attend a class taught by that specific person.</p>
<p>At ESA, the faculty who is named in the program details is the faculty who teaches every day. No swaps.</p>

<h2>5. Find out the parent communication pattern</h2>
<p>This is what separates a coaching institute from a tuition centre. A coaching institute should have a structured monthly parent meeting. Not a five-minute hallway conversation. A proper sit-down with the actual teacher to discuss what is going well, what is not, and what to do next.</p>
<p>If the institute cannot describe their parent communication system clearly, they probably do not have one.</p>

<h2>6. Ask about missed class policy</h2>
<p>Children will miss class. Festivals, illness, family functions. Ask: "If my child misses a class, what happens?" The answer should not be "we send them notes." The answer should be "they can sit in a parallel batch, or a recorded session, or come for a make-up doubt class."</p>
<p>At ESA, missed classes are recorded and shared the same day. Doubt sessions on Saturday let students catch up on anything they missed during the week.</p>

<h2>7. Walk through the facility</h2>
<p>Are the classrooms air-conditioned? Are the boards clean? Are there enough study tables? Are there water points and washrooms that work? You are paying for a space your child will spend hours in every week. Treat it like a workspace inspection.</p>

<h2>8. Look at fee transparency</h2>
<p>Avoid institutes that quote one number on the call and a different one when you reach the centre. A reasonable Rohini coaching institute will give you a clear monthly fee for the subject combination you are enrolling for. There should not be ten hidden line items.</p>

<h2>9. Talk to one current student or parent</h2>
<p>Forget the testimonials on the website. Ask: "Can I talk to a parent whose child currently studies here?" Good institutes will happily connect you. The conversation will tell you more than any brochure.</p>

<h2>10. Trust your gut on the first 15 minutes</h2>
<p>Walk in once. Sit in the reception area for ten minutes. Watch how teachers and students interact. Listen to how the front desk handles other parents. Notice if the place feels organised or chaotic.</p>
<p>Coaching is a long-term relationship. If something feels off in the first fifteen minutes, it will not get better in the next twelve months.</p>
...
<h2>1. Tests are written every Saturday, without negotiation</h2>
<p>At ESA, every Saturday between 5 PM and 8 PM is test slot. The chapter that was finished that week gets tested. The marks get recorded. A weekly parent message goes out with the score and the next week's prep plan.</p>
<p>What happens at most other institutes? Tests are scheduled. Tests get cancelled. Tests become "revision sessions." By the end of the term you discover your child has written six tests in five months instead of twenty.</p>
<p>The discipline of writing a test every Saturday for nine months is what turns a 75 percent student into a 90 percent student. Most institutes know this. Almost none enforce it.</p>

<h2>2. Doubts get cleared the same day, not "in the next class"</h2>
<p>This is a small thing but it changes outcomes. At ESA, doubt sessions happen at the end of every batch. Twenty minutes minimum. Faculty stay back. Students who do not understand a step in the lesson cannot leave the room without asking.</p>
<p>Why does this matter? Because a doubt left unresolved at the end of class becomes a permanent gap. By the time Saturday's test comes, the student has built three new lessons on top of that gap and the test score reflects it.</p>

<h2>3. Monthly parent meetings are structured, not casual</h2>
<p>The first Saturday of every month is parent meeting day. Each parent sits with the teacher for fifteen minutes. They look at the four weekly test scores together, talk about what is improving and what is not, and agree on a focus area for the next month.</p>
<p>Most other institutes do "open house" days where parents stand around and the teacher shouts general updates over the noise. Useless. The ESA structure means every parent leaves the meeting knowing exactly what to expect from their child in the next four weeks.</p>

<h2>4. Notes are written by the actual faculty, not photocopied from a chain</h2>
<p>Our chapter notes for Class 8 to Class 12 are written by the faculty teaching that subject. Same person who teaches the chapter writes the summary that students revise. So the notes match the way the lesson was taught. So when a student opens the notes during exam prep, the language and examples feel familiar.</p>
<p>Compare this to institutes that hand out printed booklets from a parent company in Kota or Delhi. The student spent the year hearing one explanation in class and reads a different explanation in the notes. Cognitive friction. Slower recall during the exam.</p>

<h2>5. Faculty stay with the same batch for years</h2>
<p>The teacher who handles your child's Class 9 batch is likely to also handle their Class 10 batch. Then their Class 11. We do not rotate faculty. Once a mentor takes a batch, they stay with it.</p>
<p>Why does this matter? Because by Class 11 your child's Math teacher already knows their handwriting, their typical mistakes, the chapters they always struggle with. They can correct a paper in five minutes instead of fifteen because they know what to look for.</p>
<p>Most coaching chains rotate faculty across centres every few months. The teacher who taught your child in Class 9 may have left by Class 10. Your child basically starts over.</p>

<h2>The combined effect</h2>
<p>Any one of these five habits done well will lift your child's marks. ESA students get all five at the same time. That is why we see a meaningful score jump in the first 90 days for almost every student who switches over from another institute in Rohini, Pitampura or Shalimar Bagh.</p>
...
<h2>Coverage of the full CBSE syllabus by January</h2>
<p>The CBSE Class 10 board exam is in February or March. A good coaching institute should finish the entire syllabus by mid-January, leaving 6 to 8 weeks pure for revision, doubt clearing and full mock exams.</p>
<p>Ask the coaching institute: "When will you finish the syllabus?" If the answer is February, walk away. You need a January finish.</p>

<h2>Subject-wise weekly tests</h2>
<p>Class 10 board has five subjects (Math, Science, Social Science, English, plus second language). Each one needs to be tested chapter-wise every week. Many institutes only test Math and Science properly and let Social Science slide. Then board day arrives and your child has no muscle memory for writing a 35-mark history answer in 25 minutes.</p>
<p>At ESA, Saturday tests rotate through every subject. By the time boards arrive, your child has written a chapter test in every subject roughly twenty times.</p>

<h2>10 plus previous year papers practised</h2>
<p>CBSE follows a very specific paper pattern. The marking is strict on language. Specific keywords give specific marks. The only way to internalise this is by practising actual past papers under exam conditions and getting them corrected.</p>
<p>Ask: "How many full previous year papers will my child write before boards?" The answer should be at least 10. With proper correction and feedback.</p>

<h2>Mock exams under exam conditions</h2>
<p>Once a month from October onwards, your child should be writing a full three-hour mock paper. Same time slot as the real exam. Same exam hall feel. Same marking pattern. By February the actual board exam feels familiar.</p>

<h2>Doubt sessions till the night before</h2>
<p>The week before boards is the most important week. Doubts that have been bottled up for months come out. Good institutes run extra doubt sessions in this final week. Some students need an hour of one-on-one time on Vector formulas the day before the Math exam. The institute should be willing to give it.</p>

<h2>What ESA does for Class 10 students</h2>
<p>Our Class 10 batches run six days a week, evening slots from 5 PM to 8:30 PM. Saturdays are reserved for weekly chapter tests. The full CBSE syllabus finishes in the first week of January every year.</p>
<p>From January to mid-February, we run only revision, doubt clearing and full mock exams. Each student writes at least 10 mock papers in this period. The teacher correcting your child's paper is the same teacher who taught the chapter all year.</p>
<p>This is why our Class 10 average score has stayed around 84 percent for the last three years. With 32 plus students above 90 every cycle.</p>
