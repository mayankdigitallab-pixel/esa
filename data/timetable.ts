...
export type CentreTimetable = {
  slug: string;
  /** Banner title, e.g. "Sector 7 · Time Table 1". */
  title: string;
...
export const timetables: CentreTimetable[] = [
    ...
    rows: [
      {
        ...
        blocks: [
          { time: "4:00 - 5:15", subject: "Hindi" },
          { time: "5:15 - 6:30", subject: "English" },
        ],
      },
      {
        classLabel: "VI",
      ...
      },
      {
        ...
        blocks: [
          { time: "5:00 - 6:00", subject: "English" },
      ...
      {
        classLabel: "XI",
        totalTime: "4:00 - 7:00 PM",
        blocks: [
          { time: "4:00 - 5:00", subject: "Chemistry" },
          { time: "5:00 - 6:00", subject: "Physics" },
          { time: "6:00 - 7:00", subject: "English" },
        ],
      },
    ],
  },
  {
    slug: "sector-7-2",
    title: "Sector 7 · Time Table 2",
    centre: "Excellent Students' Academy",
    branch: "Rohini, Sector 7, New Delhi",
    phone: "+91 94580 12793",
    downloadPath: "/timetables/sector-7-2.html",
    publicUrl: "https://www.theesa.in/timetables/sector-7-2.html",
    rows: [
      {
        classLabel: "I - V",
        totalTime: "4:00 - 6:30 PM",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        blocks: [
          { time: "6:00 - 7:00", subject: "Social Science" },
          { time: "7:00 - 8:00", subject: "English" },
        ],
      },
      {
        classLabel: "X",
      ...
      },
      {
        classLabel: "XII",
        totalTime: "5:00 - 6:00 PM",
        blocks: [{ time: "5:00 - 6:00", subject: "Economics" }],
      },
    ],
  },
  {
    slug: "sector-15-2",
    title: "Sector 15 · Time Table 2",
    centre: "Excellent Students' Academy",
    branch: "Rohini, Sector 15, New Delhi",
    phone: "+91 94580 12793",
    downloadPath: "/timetables/sector-15-2.html",
    publicUrl: "https://www.theesa.in/timetables/sector-15-2.html",
    rows: [
      {
        classLabel: "I - V",
        totalTime: "3:00 - 5:00 PM",
